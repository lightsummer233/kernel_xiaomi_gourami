...
void __init tcp_init(void)
{
	...
	init_net.ipv4.sysctl_tcp_wmem[0] = 256*1024;
	init_net.ipv4.sysctl_tcp_wmem[1] = 512*1024;
	init_net.ipv4.sysctl_tcp_wmem[2] = 1024*1024;

	init_net.ipv4.sysctl_tcp_rmem[0] = 256*8192;
	init_net.ipv4.sysctl_tcp_rmem[1] = 512*8192;
	init_net.ipv4.sysctl_tcp_rmem[2] = 1024*8192;
